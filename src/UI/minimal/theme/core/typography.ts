import { Breakpoint, TypographyVariantsOptions } from "@mui/material/styles";
...
const typography: () => TypographyOptions = () => {
  const primaryFont = "setFont(minimalTheme.fontFamily.primary)";
  const secondaryFont = "setFont(minimalTheme.fontFamily.secondary)";
